...
// Type: GB.BlackDesert.Trade.Web.Process.Models.GameTradeMarketIncludePayload
...
{
    public class GameTradeMarketIncludePayload
    {
        ...
        public GameTradeMarketIncludePayload()
        {
            this.nationCode = 0;
            this.serverNo = 0;
            this.userNo = 0L;
