...
using GB.BlackDesert.Trade.Web.Process.Api.Models;
    ...
    public class GameProcessController : Controller
    {
        ...
        public JsonResult SetMarketItemProcess([FromBody] GameTradeMarketItemInfo tradeMarketItemInfo2)
        {
            ...
            if (!ServerControlManager.This().IsLoadComplete())
            {
                ...
                return Json(tradeMarketPayload);
            }
            ...
            {
                LogUtil.WriteLog(string.Format("[Http Error]SetMarketItemProcess({0}) - pushItemModel is null", tradeMarketItemInfo2), "WARN");
            ...
            switch ((KeyType)tradeMarketItemInfo2.keyType)
            {
                case KeyType.eItem:
                    ...
                    {
                        LogUtil.WriteLog(string.Format("[Item Error]SetMarketItemProcess({0}) itemInfo({1}, {2}) Not Exist ItemInfo", tradeMarketItemInfo2, tradeMarketItemInfo2.mainKey, tradeMarketItemInfo2.subKey), "WARN");
                    ...
                    {
                        LogUtil.WriteLog(string.Format("[Item Error]SetMarketItemProcess({0}) itemInfo({1}, {2}) ItemStack is Invalid", tradeMarketItemInfo2, tradeMarketItemInfo2.mainKey, tradeMarketItemInfo2.subKey), "WARN");
                ...
                case KeyType.eServant:
                    ...
                    {
                        LogUtil.WriteLog(string.Format("[Item Error]SetMarketItemProcess({0}) itemInfo({1}, {2}) Not Exist ServantInfo", tradeMarketItemInfo2, tradeMarketItemInfo2.mainKey, tradeMarketItemInfo2.subKey), "WARN");
                        tradeMarketPayload.result.resultCode = 8;
                        tradeMarketPayload.result.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_InvalidItem");
                        return Json(tradeMarketPayload);
                    }
                    ...
                    {
                        LogUtil.WriteLog(string.Format("[Item Error]SetMarketItemProcess({0}) ServantInfo({1}, {2}) ItemStack is Invalid", tradeMarketItemInfo2, tradeMarketItemInfo2.mainKey, tradeMarketItemInfo2.subKey), "WARN");
                        tradeMarketPayload.result.resultCode = 16;
                        tradeMarketPayload.result.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_InvalidItemStack");
                        return Json(tradeMarketPayload);
                    }
                    break;
                default:
                    LogUtil.WriteLog(string.Format("[Item Error]SetMarketItemProcess({0}) itemInfo({1}) Not Exist keyType", tradeMarketItemInfo2, tradeMarketItemInfo2.keyType), "WARN");
                    tradeMarketPayload.result.resultCode = 8;
                    tradeMarketPayload.result.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_InvalidItem");
                    return Json(tradeMarketPayload);
            }
                ...
                using (SA_BETA_TRADEDB_0002 SA_BETA_TRADEDB_0002 = new SA_BETA_TRADEDB_0002())
                {
                    ...
                    if (int32 != 0)
                    {
                        ...
                        if (!Convert.ToBoolean(isNotError.Value))
                            LogUtil.WriteLog(string.Format("[DB Error]SetMarketItemProcess - uspPrepareDepositToWorldMarket({0}/{1}), rv({2})", tradeMarketItemInfo2, num, int32), "WARN");
                        else
            ...
            {
                LogUtil.WriteLog(string.Format("[DB Exception] SetMarketItemProcess({0}) - uspPrepareDepositToWorldMarket() Exception : {1}", tradeMarketItemInfo2, ex.ToString()), "ERROR");
                tradeMarketPayload.result.resultCode = 1;
                return Json(tradeMarketPayload);
            }
        ...
        public JsonResult RegisterMarketItemProcess([FromBody] GameTradeMarketIncludePayload marketIncludePayload2)
        {
            ...
            if (!ServerControlManager.This().IsLoadComplete())
            {
                ...
                return Json(marketIncludePayload1);
            }
            if (!WorldMarketLog.logDbCheck())
            {
            ...
            {
                LogUtil.WriteLog(string.Format("[Http Error]RegisterMarketItemProcess({0}) - model is null", marketIncludePayload2), "WARN");
                return Json(new GameTradeMarketIncludePayload()
                {
                    result = {
            resultCode = 5,
                ...
                using (SA_BETA_TRADEDB_0002 SA_BETA_TRADEDB_0002 = new SA_BETA_TRADEDB_0002())
                {
                    ...
                    if (int32 != 0)
                    {
                        ...
                        }, new CommonModel.TradeMarketItemLogInfo()
                        {
                            ...
                            beforeCount1 = 0L,
                            afterCount1 = 0L
                        }, marketIncludePayload2.payload, int32, marketIncludePayload2.param0, marketIncludePayload2.param1, marketIncludePayload2.param2, marketIncludePayload2.param3, marketIncludePayload2.param4, textParam1: textParam1);
                        LogUtil.WriteLog(string.Format("[DB Error]RegisterMarketItemProcess() - uspProcessDepositToWorldMarket({0}), rv({1})", marketIncludePayload2, int32), "WARN");
                        marketIncludePayload2.result.resultCode = int32;
                        marketIncludePayload2.result.resultMsg = textParam1;
                        return Json(marketIncludePayload2);
                    }
            ...
            {
                LogUtil.WriteLog(string.Format("[DB Exception]RegisterMarketItemProcess() - uspProcessDepositToWorldMarket({0}) Exception : {1}", marketIncludePayload2, ex.ToString()), "ERROR");
        ...
        public JsonResult PreWithdrawItemProcess([FromBody] GameTradeMarketItemInfo tradeMarketItemInfo2)
        {
            ...
            if (!ServerControlManager.This().IsLoadComplete())
            {
                ...
                return Json(marketIncludePayload);
            }
            if (!WorldMarketLog.logDbCheck())
            {
            ...
            if (tradeMarketItemInfo2 == null)
            {
                LogUtil.WriteLog(string.Format("[Http Error]PreWithdrawItemProcess({0}) - popItemModel is null", tradeMarketItemInfo2), "WARN");
            ...
            switch ((KeyType)tradeMarketItemInfo2.keyType)
            {
                case KeyType.eItem:
                    ...
                    if (!tradeMarketItemInfo3.isValid() && 1 != tradeMarketItemInfo2.mainKey)
                    {
                        LogUtil.WriteLog(string.Format("[Item Error]PreWithdrawItemProcess({0}) itemInfo({1}, {2}) Not Exist ItemInfo", tradeMarketItemInfo2, tradeMarketItemInfo2.mainKey, tradeMarketItemInfo2.subKey), "WARN");
                    ...
                    if (tradeMarketItemInfo3._maxStackCount < tradeMarketItemInfo2.count && 1 != tradeMarketItemInfo2.mainKey)
                    {
                        LogUtil.WriteLog(string.Format("[Item Error]PreWithdrawItemProcess({0}) itemInfo({1}, {2}) ItemStack is Invalid", tradeMarketItemInfo2, tradeMarketItemInfo2.mainKey, tradeMarketItemInfo2.subKey), "WARN");
                ...
                case KeyType.eServant:
                    ...
                    if (!tradeMarketItemInfo3.isValid())
                    {
                        LogUtil.WriteLog(string.Format("[Item Error]PreWithdrawItemProcess({0}) itemInfo({1}, {2}) Not Exist ServantInfo", tradeMarketItemInfo2, tradeMarketItemInfo2.mainKey, tradeMarketItemInfo2.subKey), "WARN");
                        marketIncludePayload.result.resultCode = 8;
                        marketIncludePayload.result.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_InvalidItem");
                        return Json(marketIncludePayload);
                    }
                    if (tradeMarketItemInfo3._maxStackCount < tradeMarketItemInfo2.count)
                    {
                        LogUtil.WriteLog(string.Format("[Item Error]PreWithdrawItemProcess({0}) ServantInfo({1}, {2}) ItemStack is Invalid", tradeMarketItemInfo2, tradeMarketItemInfo2.mainKey, tradeMarketItemInfo2.subKey), "WARN");
                        marketIncludePayload.result.resultCode = 16;
                        marketIncludePayload.result.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_InvalidItemStack");
                        return Json(marketIncludePayload);
                    }
                    break;
                default:
                    LogUtil.WriteLog(string.Format("[Item Error]PreWithdrawItemProcess({0}) itemInfo({1}) Not Exist keyType", tradeMarketItemInfo2, tradeMarketItemInfo2.keyType), "WARN");
                    marketIncludePayload.result.resultCode = 8;
                    marketIncludePayload.result.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_InvalidItem");
                    return Json(marketIncludePayload);
            }
            try
            {
                using (SA_BETA_TRADEDB_0002 SA_BETA_TRADEDB_0002 = new SA_BETA_TRADEDB_0002())
                {
                    ...
                    if (int32 != 0)
                    {
                        LogUtil.WriteLog(string.Format("[DB Error]PreWithdrawItemProcess - uspPrepareWithdrawFromWorldMarket({0}), rv({1})", tradeMarketItemInfo2, int32), "WARN");
            ...
            {
                LogUtil.WriteLog(string.Format("[DB Exception]PreWithdrawItemProcess() - uspPrepareWithdrawFromWorldMarket({0}) Exception : {1}", tradeMarketItemInfo2, ex.ToString()), "ERROR");
                marketIncludePayload.result.resultCode = 1;
                return Json(marketIncludePayload);
            }
        ...
        public JsonResult CompleteWithdrawItemProcess([FromBody] GameTradeMarketIncludePayload marketIncludePayload2)
        {
            ...
            if (marketIncludePayload2 == null)
            {
                LogUtil.WriteLog(string.Format("[Http Error]CompleteWithdrawItemProcess({0}) - model is null", marketIncludePayload2), "WARN");
                return Json(new GameTradeMarketIncludePayload()
                {
                    result = {
            resultCode = 5,
            ...
            try
            {
                using (SA_BETA_TRADEDB_0002 SA_BETA_TRADEDB_0002 = new SA_BETA_TRADEDB_0002())
                {
                    ...
                    if (int32 != 0)
                    {
                        ...
                        LogUtil.WriteLog(string.Format("[DB Error]CompleteWithdrawItemProcess - uspProcessWithdrawFromWorldMarket({0}), rv({1})", marketIncludePayload2, int32), "WARN");
                        marketIncludePayload2.result.resultCode = int32;
                        marketIncludePayload2.result.resultMsg = textParam1;
                        return Json(marketIncludePayload2);
                    }
            ...
            {
                LogUtil.WriteLog(string.Format("[DB Exception]CompleteWithdrawItemProcess() - uspProcessWithdrawFromWorldMarket({0}) Exception : {1}", marketIncludePayload2, ex.ToString()), "ERROR");
                marketIncludePayload2.result.resultCode = 1;
                return Json(marketIncludePayload2);
            }
            WorldMarketLog.logWorldMarket(operationType, WorldMarketLog.ReasonType.eWorldMarket_ReasonType_Pop, CommonModule.GetCustomTime(), new CommonModel.TradeMarketUserLogInfo()
            ...
            }, marketIncludePayload2.payload, 1L, num, marketIncludePayload2.param0, marketIncludePayload2.param1, marketIncludePayload2.param2, marketIncludePayload2.param3, Convert.ToInt64(marketIncludePayload2.isSealed));
            return Json(marketIncludePayload2);
        }
        ...
        public JsonResult CreateMyWalletProcess([FromBody] GameTradeMarketUserInfo tradeMarketUserInfo2)
        {
            ...
            {
                LogUtil.WriteLog(string.Format("[Http Error]CreateMyWalletProcess({0}) - model is null", tradeMarketUserInfo2), "WARN");
                ...
                return Json(tradeMarketUserInfo2);
            }
            ...
            {
                num1 = VariedTradeCountManager.This().getAddTradeCountByFamilyPoint(tradeMarketUserInfo2.familyPoint);
                num2 = VariedTradeCountManager.This().getAddTaxDiscountRateByFamilyPoint(tradeMarketUserInfo2.familyPoint);
            ...
            try
            {
                ...
                {
                    LogUtil.WriteLog(string.Format("[DB Error]CreateMyWalletProcess() - uspCreateMyWallet({0}/{1}/{2}/{3}), rv({4})", tradeMarketUserInfo2.nationCode, tradeMarketUserInfo2.worldNo, tradeMarketUserInfo2.userNo, tradeMarketUserInfo2.userNickName, commonResult.resultCode), "WARN");
                    return Json(commonResult);
                }
            }
            catch (Exception ex)
            {
                LogUtil.WriteLog(string.Format("[DB Exception]CreateMyWalletProcess() - uspCreateMyWallet({0}) Exception : {1}", tradeMarketUserInfo2, ex.ToString()), "ERROR");
                commonResult.resultCode = 1;
                commonResult.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_DBException");
                return Json(commonResult);
            }
        ...
        public JsonResult BuyItemProcess([FromBody] GameTradeMarketBuyInfo model)
        {
            ...
            if (model == null)
            {
                LogUtil.WriteLog(string.Format("[Http Error]BuyItemProcess({0}) - model is null", model), "WARN");
            ...
            if (ConstantMgr._serviceType.ToLower().Equals("dev").Equals(true))
            {
                ...
                {
                    LogUtil.WriteLog(string.Format("[Item Error]BuyItemProcess({0}, {1}, {2}) otpitem check resultCode : {3}", model.buyKeyType, model.buyMainKey, model.buyChooseKey, commonResult1.resultCode), "WARN");
            ...
            if (num1 != 0L)
            {
                LogUtil.WriteLog(string.Format("[Item Error]BuyItemProcess({0}) buyPrice Check Fail unitPrice({1} divide Result {2}", model, unitPrice, num1), "WARN");
                commonResult1.resultCode = 14;
                commonResult1.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_ERROR_MSG_PRICE_WORNG");
                return Json(commonResult1);
            }
            ...
            {
                LogUtil.WriteLog(string.Format("[Item Error]BuyItemProcess({0}) getEnchantMaxGroup({1}, {2}) Group : Out Of Range", model, model.buyMainKey, info1._enchantGroup), "WARN");
            ...
            if (model.buySubKey != model.buyChooseKey)
            {
                ...
                {
                    LogUtil.WriteLog(string.Format("[Item Error]BuyItemProcess({0}) getEnchantBaseMaxGroup({1}, {2}) Group : Out Of Range", model, model.buyMainKey, info3._enchantGroup), "WARN");
                    commonResult1.resultCode = 9;
                    commonResult1.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_InvalidItemGroup");
                    return Json(commonResult1);
                }
            ...
            using (SA_BETA_TRADEDB_0002 SA_BETA_TRADEDB_0002 = new SA_BETA_TRADEDB_0002())
            {
                try
                {
                    ...
                    {
                        LogUtil.WriteLog(string.Format("[DB Exception]BuyItemProcess() - uspCheckAndUpdateBlackUser({0}/{1})", model, buyCount), "WARN");
                ...
                {
                    LogUtil.WriteLog(string.Format("[DB Exception]BuyItemProcess() - uspCheckAndUpdateBlackUser({0}/{1}) Exception : {2}", model, buyCount, ex.ToString()), "ERROR");
                    commonResult1.resultCode = 1;
                    commonResult1.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_DBException");
                    return Json(commonResult1);
                }
                ...
                while (0L < buyCount)
                {
                    try
                    {
                        ...
                        if (commonResult1.resultCode == 0)
                        {
                            if (StopReasonType.eStopReasonType_Empty != int32)
                            {
                                ...
                                else if (int32 == StopReasonType.eStopReasonType_Normal)
                                {
                                    ...
                                    if (num5 == 0 && 0L < model.retryBiddingNo)
                                    {
                                        ...
                                        if (0L < Convert.ToInt64(boughtCount.Value))
                                        {
                                            ...
                                            WorldMarketLog.logWorldMarket(WorldMarketLog.OperationType.eWorldMarket_OperationType_Item, WorldMarketLog.ReasonType.eWorldMarket_ReasonType_BiddingBuyCalculate, CommonModule.GetCustomTime(), userInfo, itemInfo, model.retryBiddingNo, 1L, model.buyChooseKey, Convert.ToInt64(model.isWebAccess));
                                        }
                                        if (0L < int64_8)
                                        {
                                ...
                                {
                                    LogUtil.WriteLog(string.Format("[DB Error]BuyItemProcess - uspBuyBiddingFromWorldMarket({0}/{1}) StopReasonType({2}) is Invalid", model, buyCount, (int)int32), "WARN");
                        ...
                        {
                            LogUtil.WriteLog(string.Format("[DB Error]BuyItemProcess - uspBuyBiddingFromWorldMarket({0}/{1}), rv({2})", model, buyCount, commonResult1.resultCode), "WARN");
                            commonResult1.resultMsg = Convert.ToString(symNo.Value);
                            return Json(commonResult1);
                        }
                    }
                    ...
                    {
                        LogUtil.WriteLog(string.Format("[DB Exception]BuyItemProcess() - uspBuyBiddingFromWorldMarket({0}/{1}) Exception : {2}", model, buyCount, ex.ToString()), "ERROR");
                        commonResult1.resultCode = 1;
                        commonResult1.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_DBException");
                        return Json(commonResult1);
                    }
                ...
                if (buyCount == 0L)
                {
                    ...
                    Task.Run(() => TradeModule.SendPearlAppAlarm(ref sellUserIdList, model.buyMainKey, "SELL"));
                    return Json(commonResult1);
                }
                bool flag2 = false;
                ...
                try
                {
                    ...
                    if (commonResult1.resultCode == 0)
                    {
                        ...
                        if (0L < int64_17)
                        {
                            ...
                            WorldMarketLog.logWorldMarket(WorldMarketLog.OperationType.eWorldMarket_OperationType_Item, WorldMarketLog.ReasonType.eWorldMarket_ReasonType_Buy, customTime, userInfo, itemInfo, model.buyChooseKey, Convert.ToInt64(model.isWebAccess), model.retryBiddingNo);
                        }
                        if (int64_20 != 0L)
                        {
                    ...
                    LogUtil.WriteLog(string.Format("[DB Error]BuyItemProcess - uspBuyFromWorldMarket({0}/{1}), rv({2})", model, buyCount, commonResult1.resultCode), "WARN");
                    commonResult1.resultMsg = Convert.ToString(symNo.Value);
                    Task.Run(() => TradeModule.SendPearlAppAlarm(ref sellUserIdList, model.buyMainKey, "SELL"));
                    return Json(commonResult1);
                }
                ...
                {
                    LogUtil.WriteLog(string.Format("[DB Exception]BuyItemProcess() - uspBuyFromWorldMarket({0}/{1}) Exception : {2}", model, buyCount, ex.ToString()), "ERROR");
                    commonResult1.resultCode = 1;
                    commonResult1.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_DBException");
                    return Json(commonResult1);
                }
                ...
                else
                {
                    ...
                    using (SA_BETA_TRADEDB_0002 SA_BETA_TRADEDB_0002 = new SA_BETA_TRADEDB_0002())
                    {
                        while (0L < num1)
                        {
                            ...
                            {
                                LogUtil.WriteLog(string.Format("[DB Exception]BuyItemProcess() - uspBuyBiddingFromWorldMarket({0}) Exception : {1}", num1, ex.ToString()), "ERROR");
                                return;
                            }
                        }
                        if (num1 == 0L)
                        ...
                        {
                            LogUtil.WriteLog(string.Format("[DB Exception]BuyItemProcess() - uspBuyFromWorldMarket({0}) Exception : {1}", num1, ex.ToString()), "ERROR");
                        }
                    }
                }
            }
        ...
        public JsonResult SellItemProcess([FromBody] GameTradeMarketSellInfo model)
        {
            ...
            if (model == null)
            {
                LogUtil.WriteLog(string.Format("[Http Error]SellItemProcess({0}) - model is null", model), "WARN");
                commonResult1.resultCode = 5;
                commonResult1.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_JSONIsNull");
                return Json(model);
            }
            if (ConstantMgr._serviceType.ToLower().Equals("dev").Equals(true))
            {
                ...
                if (commonResult1.resultCode != 0)
                {
                    LogUtil.WriteLog(string.Format("[Item Error]SellItemProcess({0}, {1}, {2}) otpitem check resultCode : {3}", model.sellKeyType, model.sellMainKey, model.sellChooseKey, commonResult1.resultCode), "WARN");
                    commonResult1.resultCode = 14;
                    commonResult1.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_ERROR_MSG_PRICE_WORNG");
                }
                if (result)
            ...
            if (num3 != 0L)
            {
                LogUtil.WriteLog(string.Format("[Item Error]SellItemProcess({0}) sellPrice Check Fail unitPrice({1} divide Result {2}", model, unitPrice, num3), "WARN");
                commonResult1.resultCode = 14;
                commonResult1.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_ERROR_MSG_PRICE_WORNG");
                return Json(commonResult1);
            }
            ...
            {
                LogUtil.WriteLog(string.Format("[Item Error]SellItemProcess({0}) getEnchantMaxGroup({1}, {2}) Group : Out Of Range", model, model.sellMainKey, info1._enchantGroup), "WARN");
                commonResult1.resultCode = 9;
                commonResult1.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_InvalidItemGroup");
                return Json(commonResult1);
            }
            if (model.sellSubKey != model.sellChooseKey)
            {
                ...
                {
                    LogUtil.WriteLog(string.Format("[Item Error]SellItemProcess({0}) getEnchantBaseMaxGroup({1}, {2}) Group : Out Of Range", model, model.sellMainKey, info2._enchantGroup), "WARN");
                    commonResult1.resultCode = 9;
                    commonResult1.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_InvalidItemGroup");
                    return Json(commonResult1);
                }
            ...
            using (SA_BETA_TRADEDB_0002 SA_BETA_TRADEDB_0002 = new SA_BETA_TRADEDB_0002())
            {
                try
                {
                    ...
                    if (Convert.ToBoolean(blocked.Value))
                    {
                        LogUtil.WriteLog(string.Format("[DB Exception]SellItemProcess() - uspCheckAndUpdateBlackUser({0}) Exception ", model), "WARN");
                        commonResult1.resultCode = 24;
                        commonResult1.resultMsg = Convert.ToString(symNo.Value);
                        return Json(commonResult1);
                    }
                ...
                {
                    LogUtil.WriteLog(string.Format("[DB Exception]SellItemProcess() - uspCheckAndUpdateBlackUser({0}) Exception : {1}", model, ex.ToString()), "ERROR");
                    commonResult1.resultCode = 1;
                    commonResult1.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_DBException");
                    return Json(commonResult1);
                }
                ...
                while (0L < sellCount)
                {
                    try
                    {
                        ...
                        if (commonResult1.resultCode == 0)
                        {
                            if (StopReasonType.eStopReasonType_Empty != int32)
                            {
                                ...
                                else if (int32 == StopReasonType.eStopReasonType_Normal)
                                {
                                    ...
                                    if (num9 == 0 && 0L < model.retryBiddingNo)
                                    {
                                        ...
                                        if (0L < num5)
                                        {
                                            ...
                                            WorldMarketLog.logWorldMarket(WorldMarketLog.OperationType.eWorldMarket_OperationType_Item, WorldMarketLog.ReasonType.eWorldMarket_ReasonType_BiddingSellCalculate, CommonModule.GetCustomTime(), userInfo, itemInfo, model.retryBiddingNo, 1L, num5, Convert.ToInt32(model.isSealed), int64_9, Convert.ToInt64(model.isWebAccess), int64_8, Convert.ToInt64(boolean), textParam1: packageExpiration.Value.ToString());
                                        }
                                        if (0L < int64_5)
                                        {
                                            itemInfo.count1 = int64_5;
                                            ...
                                            itemInfo.beforeCount2 = 0L;
                                            itemInfo.afterCount2 = 0L;
                                            WorldMarketLog.logWorldMarket(WorldMarketLog.OperationType.eWorldMarket_OperationType_Item, WorldMarketLog.ReasonType.eWorldMarket_ReasonType_BiddingSellWithdraw, customTime, userInfo, itemInfo, model.retryBiddingNo, 1L, model.sellChooseKey, Convert.ToInt32(model.isSealed), Convert.ToInt64(model.isWebAccess));
                                        }
                                        flag2 = true;
                                    }
                                    ...
                                    WorldMarketLog.logWorldMarket(WorldMarketLog.OperationType.eWorldMarket_OperationType_Item, 0L < Convert.ToInt64(resultWaitNo.Value) ? WorldMarketLog.ReasonType.eWorldMarket_ReasonType_SellWait : WorldMarketLog.ReasonType.eWorldMarket_ReasonType_SellBidding, customTime, userInfo, itemInfo, int64_4, model.sellChooseKey, Convert.ToInt64(model.isSealed), int64_3, Convert.ToInt64(model.isWebAccess), Convert.ToInt64(num1), Convert.ToInt64(resultWaitNo.Value), Convert.ToInt64(buyUserNo.Value), Convert.ToInt64(raceCount.Value), Convert.ToInt64(model.isRingBuff), model.retryBiddingNo, textParam1: packageExpiration.Value.ToString());
                                    ++num9;
                                    if (0L < int64_4)
                                    {
                                ...
                                {
                                    LogUtil.WriteLog(string.Format("[DB Error]SellItemProcess - uspSellBiddingToWorldMarket({0}/{1}) StopReasonType({2}) is Invalid", model, sellCount, (int)int32), "WARN");
                        ...
                        {
                            LogUtil.WriteLog(string.Format("[DB Error]SellItemProcess - uspSellBiddingToWorldMarket({0}/{1}), rv({2})", model, sellCount, commonResult1.resultCode), "WARN");
                            commonResult1.resultMsg = Convert.ToString(symNo.Value);
                            return Json(commonResult1);
                        }
                    }
                    ...
                    {
                        LogUtil.WriteLog(string.Format("[DB Exception]SellItemProcess() - uspSellBiddingToWorldMarket({0}/{1}) Exception : {2}", model, sellCount, ex.ToString()), "ERROR");
                        commonResult1.resultCode = 1;
                        commonResult1.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_DBException");
                        return Json(commonResult1);
                    }
                ...
                if (!flag2 && 0L < model.retryBiddingNo)
                {
                    ...
                    if (0L < num5)
                    {
                        ...
                        WorldMarketLog.logWorldMarket(WorldMarketLog.OperationType.eWorldMarket_OperationType_Item, WorldMarketLog.ReasonType.eWorldMarket_ReasonType_BiddingSellCalculate, CommonModule.GetCustomTime(), userInfo, itemInfo, model.retryBiddingNo, 1L, num5, Convert.ToInt32(model.isSealed), int64_16, Convert.ToInt64(model.isWebAccess), int64_15, Convert.ToInt64(boolean), textParam1: packageExpiration.Value.ToString());
                    }
                    if (0L < int64_12)
                    {
                ...
                try
                {
                    ...
                    if (commonResult1.resultCode == 0)
                    {
                        ...
                        if (0L < int64_22)
                        {
                            ...
                            itemInfo.beforeCount2 = 0L;
                            itemInfo.afterCount2 = 0L;
                            WorldMarketLog.logWorldMarket(WorldMarketLog.OperationType.eWorldMarket_OperationType_Item, WorldMarketLog.ReasonType.eWorldMarket_ReasonType_BiddingSellRegister, customTime, userInfo, itemInfo, int64_22, model.sellChooseKey, Convert.ToInt64(model.isSealed), model.sellPrice, Convert.ToInt64(model.isWebAccess), Convert.ToInt64(model.isRingBuff), Convert.ToInt64(num1), model.retryBiddingNo, textParam1: packageExpiration.Value.ToString());
                        }
                    }
                    else
                    {
                        ...
                        LogUtil.WriteLog(string.Format("[DB Error]SellItemProcess - uspSellToWorldMarket({0}/{1}), rv({2})", model, sellCount, commonResult1.resultCode), "WARN");
                        commonResult1.resultMsg = Convert.ToString(symNo.Value);
                    }
                }
                catch (Exception ex)
                {
                    LogUtil.WriteLog(string.Format("[DB Exception]SellItemProcess() - uspSellToWorldMarket({0}/{1}) Exception : {2}", model, sellCount, ex.ToString()), "ERROR");
                    commonResult1.resultCode = 1;
                    commonResult1.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_DBException");
                    return Json(commonResult1);
                }
        ...
        public JsonResult WithdrawBuyBiddingProcess([FromBody] GameTradeMarketBiddingInfo marketBiddingInfo2)
        {
            ...
            {
                LogUtil.WriteLog(string.Format("[Http Error]WithdrawBuyBiddingProcess({0}) - model is null", marketBiddingInfo2), "WARN");
                commonResult.resultCode = 5;
                commonResult.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_JSONIsNull");
                return Json(commonResult);
            }
            ...
            if (!info.isValid())
            {
                LogUtil.WriteLog(string.Format("[Item Error]WithdrawBuyBiddingProcess({0}) itemInfo({1}, {2}) Not Exist ItemInfo", marketBiddingInfo2, marketBiddingInfo2.mainKey, marketBiddingInfo2.subKey), "WARN");
            ...
            using (SA_BETA_TRADEDB_0002 SA_BETA_TRADEDB_0002 = new SA_BETA_TRADEDB_0002())
            {
                try
                {
                    ...
                    if (commonResult.resultCode != 0)
                    {
                        LogUtil.WriteLog(string.Format("[DB Error]WithdrawBuyBiddingProcess - uspWithdrawBiddingBuy({0}), rv({1})", marketBiddingInfo2, commonResult.resultCode), "WARN");
                        commonResult.resultMsg = Convert.ToString(symNo.Value);
                        return Json(commonResult);
                    }
                    ...
                    }, marketBiddingInfo2.biddingNo, Convert.ToInt32(isDelete.Value), Convert.ToInt64(differenceMoney.Value), Convert.ToInt64(marketBiddingInfo2.isWebAccess));
                }
                catch (Exception ex)
                {
                    LogUtil.WriteLog(string.Format("[DB Exception]WithdrawBuyBiddingProcess() - uspWithdrawBiddingBuy({0}) Exception : {1}", marketBiddingInfo2, ex.ToString()), "ERROR");
                    commonResult.resultCode = 1;
                    commonResult.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_DBException");
                    return Json(commonResult);
                }
        ...
        public JsonResult CalculateBuyBiddingProcess([FromBody] GameTradeMarketBiddingInfo marketBiddingInfo2)
        {
            ...
            if (marketBiddingInfo2 == null)
            {
                LogUtil.WriteLog(string.Format("[Http Error]CalculateBuyBiddingProcess({0}) - model is null", marketBiddingInfo2), "WARN");
                commonResult.resultCode = 5;
                commonResult.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_JSONIsNull");
                return Json(commonResult);
            }
            ...
            if (!info.isValid())
            {
                LogUtil.WriteLog(string.Format("[Item Error]CalculateBuyBiddingProcess({0}) itemInfo({1}, {2}) Not Exist ItemInfo", marketBiddingInfo2, marketBiddingInfo2.mainKey, marketBiddingInfo2.subKey), "WARN");
                commonResult.resultCode = 8;
                commonResult.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_InvalidItem");
                return Json(commonResult);
            }
            using (SA_BETA_TRADEDB_0002 SA_BETA_TRADEDB_0002 = new SA_BETA_TRADEDB_0002())
            {
                try
                {
                    SA_BETA_TRADEDB_0002.uspCalculateBiddingBuy(new long?(marketBiddingInfo2.biddingNo), new int?(marketBiddingInfo2.keyType), new int?(marketBiddingInfo2.mainKey), new int?(info._enchantGroup), new int?(marketBiddingInfo2.nationCode), new int?(marketBiddingInfo2.serverNo), new long?(marketBiddingInfo2.userNo), new long?(info._weight), new long?(WorldMarketOptionManager.This().getMaxWeight() * WorldMarketOptionManager.This().getMaxWeightRate()), boughtCount, chooseSubKey, isDelete, beforeCount1, afterCount1, symNo, rv);
                    commonResult.resultCode = Convert.ToInt32(rv.Value);
                    if (commonResult.resultCode != 0)
                    {
                        LogUtil.WriteLog(string.Format("[DB Error]CalculateBuyBiddingProcess - uspCalculateBiddingBuy({0}), rv({1})", marketBiddingInfo2, commonResult.resultCode), "WARN");
                        commonResult.resultMsg = Convert.ToString(symNo.Value);
                        return Json(commonResult);
                    }
                    ...
                    }, new CommonModel.TradeMarketItemLogInfo()
                    {
                        ...
                        beforeCount1 = Convert.ToInt64(beforeCount1.Value),
                        afterCount1 = Convert.ToInt64(afterCount1.Value)
                    }, marketBiddingInfo2.biddingNo, Convert.ToInt32(isDelete.Value), Convert.ToInt32(chooseSubKey.Value), Convert.ToInt64(marketBiddingInfo2.isWebAccess), Convert.ToInt64(boughtCount.Value));
                }
                catch (Exception ex)
                {
                    LogUtil.WriteLog(string.Format("[DB Exception]CalculateBuyBiddingProcess() - uspCalculateBiddingBuy({0}) Exception : {1}", marketBiddingInfo2, ex.ToString()), "ERROR");
                    commonResult.resultCode = 1;
                    commonResult.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_DBException");
                    return Json(commonResult);
                }
        ...
        public JsonResult WithdrawSellBiddingProcess([FromBody] GameTradeMarketBiddingInfo marketBiddingInfo2)
        {
            ...
            if (marketBiddingInfo2 == null)
            {
                LogUtil.WriteLog(string.Format("[Http Error]WithdrawSellBiddingProcess({0}) - model is null", marketBiddingInfo2), "WARN");
                commonResult.resultCode = 5;
                commonResult.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_JSONIsNull");
                return Json(commonResult);
            }
            ...
            if (!info.isValid())
            {
                LogUtil.WriteLog(string.Format("[Item Error]WithdrawSellBiddingProcess({0}) itemInfo({1}, {2}) Not Exist ItemInfo", marketBiddingInfo2, marketBiddingInfo2.mainKey, marketBiddingInfo2.subKey), "WARN");
                commonResult.resultCode = 8;
                commonResult.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_InvalidItem");
                return Json(commonResult);
            }
            ...
            using (SA_BETA_TRADEDB_0002 SA_BETA_TRADEDB_0002 = new SA_BETA_TRADEDB_0002())
            {
                try
                {
                    SA_BETA_TRADEDB_0002.uspWithdrawBiddingSell(new long?(marketBiddingInfo2.biddingNo), new int?(marketBiddingInfo2.keyType), new int?(marketBiddingInfo2.mainKey), new int?(info._enchantGroup), new bool?(marketBiddingInfo2.isSealed), new long?(marketBiddingInfo2.count), new int?(marketBiddingInfo2.nationCode), new int?(marketBiddingInfo2.serverNo), new long?(marketBiddingInfo2.userNo), new long?(info._weight), new long?(WorldMarketOptionManager.This().getMaxWeight() * WorldMarketOptionManager.This().getMaxWeightRate()), new long?(WorldMarketOptionManager.This().getBiddingPercent()), new DateTime?(customTime), chooseSubKey, isDelete, beforeCount1, afterCount1, symNo, rv);
                    commonResult.resultCode = Convert.ToInt32(rv.Value);
                    if (commonResult.resultCode != 0)
                    {
                        LogUtil.WriteLog(string.Format("[DB Error]WithdrawSellBiddingProcess - uspWithdrawBiddingSell({0}), rv({1})", marketBiddingInfo2, commonResult.resultCode), "WARN");
                        commonResult.resultMsg = Convert.ToString(symNo.Value);
                        return Json(commonResult);
                    }
                    ...
                    }, new CommonModel.TradeMarketItemLogInfo()
                    {
                        ...
                        beforeCount1 = Convert.ToInt64(beforeCount1.Value),
                        afterCount1 = Convert.ToInt64(afterCount1.Value)
                    }, marketBiddingInfo2.biddingNo, Convert.ToInt32(isDelete.Value), Convert.ToInt32(chooseSubKey.Value), Convert.ToInt32(marketBiddingInfo2.isSealed), Convert.ToInt64(marketBiddingInfo2.isWebAccess));
                }
                catch (Exception ex)
                {
                    LogUtil.WriteLog(string.Format("[DB Exception]WithdrawSellBiddingProcess() - uspWithdrawBiddingSell({0}) Exception : {1}", marketBiddingInfo2, ex.ToString()), "ERROR");
                    commonResult.resultCode = 1;
                    commonResult.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_DBException");
                    return Json(commonResult);
                }
        ...
        public JsonResult CalculateSellBiddingProcess([FromBody] GameTradeMarketBiddingInfo marketBiddingInfo2)
        {
            ...
            if (marketBiddingInfo2 == null)
            {
                LogUtil.WriteLog(string.Format("[Http Error]CalculateSellBiddingProcess({0}) - model is null", marketBiddingInfo2), "WARN");
                commonResult.resultCode = 5;
                commonResult.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_JSONIsNull");
                return Json(commonResult);
            }
            ...
            if (!info.isValid())
            {
                LogUtil.WriteLog(string.Format("[Item Error]CalculateSellBiddingProcess({0}) itemInfo({1}, {2}) Not Exist ItemInfo", marketBiddingInfo2, marketBiddingInfo2.mainKey, marketBiddingInfo2.subKey), "WARN");
                commonResult.resultCode = 8;
                commonResult.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_InvalidItem");
                return Json(commonResult);
            }
            using (SA_BETA_TRADEDB_0002 SA_BETA_TRADEDB_0002 = new SA_BETA_TRADEDB_0002())
            {
                try
                {
                    ...
                    if (commonResult.resultCode != 0)
                    {
                        LogUtil.WriteLog(string.Format("[DB Error]CalculateSellBiddingProcess - uspCalculateBiddingSell({0}), rv({1})", marketBiddingInfo2, commonResult.resultCode), "WARN");
                        commonResult.resultMsg = Convert.ToString(symNo.Value);
                        return Json(commonResult);
                    }
                    ...
                    }, new CommonModel.TradeMarketItemLogInfo()
                    {
                        ...
                        beforeCount2 = Convert.ToInt64(beforeCount1.Value),
                        afterCount2 = Convert.ToInt64(afterCount1.Value)
                    }, marketBiddingInfo2.biddingNo, Convert.ToInt32(isDelete.Value), Convert.ToInt64(amountMoney.Value), Convert.ToInt32(marketBiddingInfo2.isSealed), Convert.ToInt64(originalTotalMoneyCount.Value), Convert.ToInt64(marketBiddingInfo2.isWebAccess), Convert.ToInt64(soldCount.Value), Convert.ToInt64(isAppledRingBuff.Value), textParam1: packageExpiration.Value.ToString());
                }
                catch (Exception ex)
                {
                    LogUtil.WriteLog(string.Format("[DB Exception]CalculateSellBiddingProcess() - uspCalculateBiddingSell({0}) Exception : {1}", marketBiddingInfo2, ex.ToString()), "ERROR");
                    commonResult.resultCode = 1;
                    commonResult.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_DBException");
                    return Json(commonResult);
                }
        ...
        public JsonResult ProcessCommand([FromBody] string commandString)
        {
            ...
            //    return this.Json((object)commonResult);
            //}
            commonResult.resultCode = _commnadProcess.process(commandString);
        ...
        public JsonResult SyncNoticeItemListProcess([FromBody] long num)
        {
            ...
            using (SA_BETA_TRADEDB_0002 SA_BETA_TRADEDB_0002 = new SA_BETA_TRADEDB_0002())
            {
                try
                {
                    commonDbResult.list = SA_BETA_TRADEDB_0002.uspListNoticeItem(new long?(num), rv, symNo).ToList();
                }
                catch (Exception ex)
                {
                    LogUtil.WriteLog(string.Format("[DB Error]SyncNoticeItemListProcess - uspListNoticeItem ({0})", ex.ToString()), "ERROR");
        ...
        public JsonResult updateCurrentPriceProcess()
        {
            ...
            KeyValuePair<int, int> nextCategory = CategoryInfoManager.This().getNextCategory(ref currentIndex);
            try
            {
                using (SA_BETA_TRADEDB_0002 SA_BETA_TRADEDB_0002 = new SA_BETA_TRADEDB_0002())
                    commonDbResult.list = SA_BETA_TRADEDB_0002.uspListWorldMarketCurrentPrice(new int?(nextCategory.Key), new int?(nextCategory.Value), symNo, rv).ToList();
            }
            catch (Exception ex)
            {
                LogUtil.WriteLog(string.Format("[DB Error]SyncNoticeItemListProcess - uspListNoticeItem () errorMsg : {0}", ex.ToString()), "ERROR");
                commonDbResult.resultCode = 1;
                commonDbResult.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_DBException");
                return Json(commonDbResult);
            }
        ...
        {
            CommonResult commonResult = new CommonResult();
            MaintenanceResponseModel maintenanceResponseModel = null;
            string str = string.Empty;
            ...
            try
            {
                using (SA_BETA_TRADEDB_0002 SA_BETA_TRADEDB_0002 = new SA_BETA_TRADEDB_0002())
                {
                    ...
                    commonResult.resultMsg = JsonConvert.SerializeObject(maintenanceResponseModel);
                }
            }
            catch (Exception ex)
            {
                ...
                commonResult.resultMsg = "[Process]Maintenance Information Save Exception Error.";
                LogUtil.WriteLog(string.Format("[Exception] SetMaintenanceTradeMarket() : {0}", ex.ToString()), "ERROR");
            }
            return Json(commonResult);
        }
        ...
        public JsonResult CheckWithDrawPayLoadProcess([FromBody] GameTradeMarketIncludePayload marketIncludePayload2)
        {
            ...
            {
                LogUtil.WriteLog(string.Format("[Http Error]CheckWithDrawPayLoadProcess({0}) - model is null", marketIncludePayload2), "WARN");
                commonResult.resultCode = 2;
                commonResult.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_HttpException");
                tradeMarketState.result = commonResult;
                return Json(tradeMarketState);
            }
            try
            {
                ...
                using (SA_BETA_TRADEDB_0002 SA_BETA_TRADEDB_0002 = new SA_BETA_TRADEDB_0002())
                {
                    ...
                    if (int32 != 0)
                    {
                        LogUtil.WriteLog(string.Format("[DB Error]CheckWithDrawPayLoadProcess - uspGetWithDrawPayLoadState({0}/{1}), rv({2})", marketIncludePayload2, str, int32), "WARN");
            ...
            {
                LogUtil.WriteLog(string.Format("[DB Exception]CheckWithDrawPayLoadProcess() - uspGetWithDrawPayLoadState({0}) Exception : {1}", marketIncludePayload2, ex.ToString()), "ERROR");
                commonResult.resultCode = 1;
                commonResult.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_DBException");
                tradeMarketState.result = commonResult;
                return Json(tradeMarketState);
        ...
        public JsonResult GetMyWalletInfoProcess([FromBody] GameTradeMarketUserId tradeMarketUserId2)
        {
            ...
            if (!ServerControlManager.This().IsLoadComplete())
            {
                ...
                return Json(infomationResultModel);
            }
            if (!WorldMarketLog.logDbCheck())
            {
            ...
            {
                LogUtil.WriteLog(string.Format("[Http Error]CalculateSellBiddingProcess({0}) - model is null", tradeMarketUserId2), "WARN");
            ...
            try
            {
                ...
                {
                    LogUtil.WriteLog(string.Format("[DB ERROR]uspGetMyWalletInfo({0}) - can't find userinfo ", tradeMarketUserId2._accountNo), "WARN");
                    infomationResultModel._result.resultCode = 1;
                    infomationResultModel._result.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_DBException");
                    return Json(infomationResultModel);
                }
                infomationResultModel._userInfo = new UserInfomationModel()
                {
                    ...
                    _valuePackageExpiration = Convert.ToDateTime(valuepackage.Value).AddHours(ConstantMgr._serviceUtcTime),
                    _addWeightBuffExpiration = Convert.ToDateTime(addWeightBuff.Value).AddHours(ConstantMgr._serviceUtcTime)
                };
            }
            catch (Exception ex)
            {
                LogUtil.WriteLog(string.Format("[DB Exception]CalculateSellBiddingProcess() - uspCalculateBiddingSell({0}) Exception : {1}", tradeMarketUserId2, ex.ToString()), "ERROR");
                infomationResultModel._result.resultCode = 1;
                infomationResultModel._result.resultMsg = CommonModule.GetResourceValue("TRADE_MARKET_WEB_ERROR_eWorldTradeMarketErrorNo_DBException");
                return Json(infomationResultModel);
            }
