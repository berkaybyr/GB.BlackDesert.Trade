...
// Type: GB.BlackDesert.Trade.Web.Models.WorldMarketListModel
...
{
    public class WorldMarketListModel : CommonResult
    {
        public List<WorldMarketInfoModel> marketList { get; set; }
    }
}
