...
namespace GB.BlackDesert.Trade.Web.Api.Controllers
{
    ...
    public class HomeController : BaseController
    {
        ...
        [ResponseCache(Duration = 1, VaryByQueryKeys = new string[] { "mainCategory", "subCategory" })]
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        [ResponseCache(Duration = 1, VaryByQueryKeys = new string[] { "mainKey" })]
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        [ResponseCache(Duration = 1, VaryByQueryKeys = new string[] { "keyType", "mainKey", "subKey" })]
        [HttpPost]
        [ValidateAntiForgeryToken]
          ...
          bool isUp)
        {
            ...
            try
            {
                ...
                ItemPriceInfoModel data1 = (ItemPriceInfoModel)this.GetItemPriceUnitList(new int?(keyType), new int?(mainKey), new int?(_itemStaticStatus._enchantGroup), new bool?(isUp)).Value;
                ...
                WorldMarketSubOneModel data2 = (WorldMarketSubOneModel)this.GetWorldMarketSubOne(new int?(mainKey), new int?(subKey)).Value;
                ...
                if (commonDbResult2.resultCode != 0)
                {
                    ...
                    return Json((object)sellBuyInfoModel);
                }
