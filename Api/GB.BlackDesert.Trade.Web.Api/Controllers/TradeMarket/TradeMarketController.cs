    ...
    public class TradeMarketController : Controller
    {
        ...
        public ActionResult GetWorldMarketList(GetWorldMarketListModel model)
        {
            ...
            if (!ServerControlManager.This().IsLoadComplete())
            {
                ...
                return Json((object)commonResult);
            }
            ...
            return ConstantMgr._isCompression ? File(CompressionModule.HaffmanCompression(stockListByCategory.resultMsg), "application/octet-stream") : Json((object)stockListByCategory);
        }
        ...
        public ActionResult GetWorldMarketHotList()
        {
            ...
            return ConstantMgr._isCompression ? File(CompressionModule.HaffmanCompression(result.resultMsg), "application/octet-stream") : Json((object)result);
        }
