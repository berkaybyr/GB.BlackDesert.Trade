...
// Type: GB.BlackDesert.Trade.Web.Models.WorldMarketDetailListModel
...
{
    public class WorldMarketDetailListModel : CommonResult
    {
        public List<WorldMarketDetailInfoModel> detailList { get; set; }
    }
}
