...
// Type: GB.BlackDesert.Trade.Web.Models.WorldMarketHotListModel
...
{
    public class WorldMarketHotListModel : CommonResult
    {
        public List<WorldMarketHotListInfoModel> hotList { get; set; }
    }
}
