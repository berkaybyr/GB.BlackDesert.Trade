    ...
    public class PearlabyssController : BaseController
    {
        ...
        public RedirectResult Index()
        {
            ...
            try
            {
                ...
                string strMsg;
                string str;
                if (HttpContext.Request.Headers["uuid"] != null)
                {
                ...
                string strCookieValue = this.Server.UrlEncode(new SecurityLib().Encrypt(strMsg, SecurityMgr.Enum.AES));
        ...
        public ActionResult Oauth2CallBack(Oauth2CallBackModel model)
        {
            ...
            try
            {
                ...
                string str1 = new SecurityLib().Decrypt(this.Server.UrlDecode(CookieLib.GetCookie(ConstantMgr._oauthCookieName)), SecurityMgr.Enum.AES);
