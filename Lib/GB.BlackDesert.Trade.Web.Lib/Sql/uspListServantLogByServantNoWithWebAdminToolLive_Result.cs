...
namespace BlackDesert.TradeMarket.Lib.Sql
{
    ...
    public partial class uspListServantLogByServantNoWithWebAdminToolLive_Result
    {
        ...
        public Nullable<long> C_servantNo { get; set; }
        public string C_servantName { get; set; }
        public Nullable<int> C_servantLevel { get; set; }
        public Nullable<long> C_servantExperience { get; set; }
        public Nullable<int> C_servantCharacterKey { get; set; }
        public Nullable<int> C_regionKey { get; set; }
        public Nullable<long> C_param1 { get; set; }
        public Nullable<long> C_param2 { get; set; }
        public Nullable<long> C_param3 { get; set; }
        public Nullable<short> C_servantCurrentFieldNo { get; set; }
        public Nullable<short> C_servantCurrentFieldIndex { get; set; }
        public Nullable<long> C_servantCurrentPositionX { get; set; }
        public Nullable<long> C_servantCurrentPositionY { get; set; }
        public Nullable<long> C_servantCurrentPositionZ { get; set; }
