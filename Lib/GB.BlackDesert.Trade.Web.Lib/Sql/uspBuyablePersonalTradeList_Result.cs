...
namespace BlackDesert.TradeMarket.Lib.Sql
{
    ...
    public partial class uspBuyablePersonalTradeList_Result
    {
        ...
        public int C_fromNationCode { get; set; }
        public int C_fromServerNo { get; set; }
        public long C_fromUserNo { get; set; }
