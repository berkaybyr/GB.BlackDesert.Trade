...
namespace BlackDesert.TradeMarket.Lib.Sql
{
    ...
    public partial class SA_BETA_GAMEDB_0002 : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> uspFamilySKillListFromWorldMarket(Nullable<long> userNo, ObjectParameter symNo, ObjectParameter rv)
        {
            var userNoParameter = userNo.HasValue ?
                new ObjectParameter("userNo", userNo) :
                new ObjectParameter("userNo", typeof(long));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("uspFamilySKillListFromWorldMarket", userNoParameter, symNo, rv);
        }
