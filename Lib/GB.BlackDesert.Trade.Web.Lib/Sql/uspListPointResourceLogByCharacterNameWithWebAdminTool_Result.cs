...
namespace BlackDesert.TradeMarket.Lib.Sql
{
    ...
    public partial class uspListPointResourceLogByCharacterNameWithWebAdminTool_Result
    {
        ...
        public Nullable<byte> C_resourceType { get; set; }
        public Nullable<int> C_variedPoint { get; set; }
        public Nullable<int> C_remainedPoint { get; set; }
        public Nullable<int> C_aquiredPoint { get; set; }
