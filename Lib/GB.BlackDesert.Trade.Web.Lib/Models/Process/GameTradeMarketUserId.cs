...
// Type: GB.BlackDesert.Trade.Web.Process.Models.GameTradeMarketUserId
...
{
    public class GameTradeMarketUserId
    {
        public long _accountNo { set; get; }

        public GameTradeMarketUserId() => this._accountNo = 0L;
    }
}
