...
namespace GB.BlackDesert.Trade.Web.Lib.Manager
{
    ...
    {
        public static readonly bool _isUseProxy = ConfigurationManager.AppSettings["isProxy"].ConvertTo<bool>(false);
        public static readonly string _webProxyUrl = ConfigurationManager.AppSettings["webProxyUrl"] ?? string.Empty;
        public static readonly int _webProxyPort = ConfigurationManager.AppSettings["webProxyPort"].ConvertTo<int>(0);
        public static readonly bool _isUseS3 = ConfigurationManager.AppSettings["USES3"].ConvertTo<bool>(false);
        public static readonly string _s3RegionName = ConfigurationManager.AppSettings["S3RegionName"] ?? "ap-northeast-2";
        public static readonly string _AWSNationalDir = ConfigurationManager.AppSettings["AWSNationalDir"] ?? "/";
        public static readonly string _AWSBaseBuketName = ConfigurationManager.AppSettings["AWSBaseBuketName"] ?? "pa.blackdesert.all.web-static/s1/";
        public static readonly string _AWSStaticBuketName = ConfigurationManager.AppSettings["AWSStaticBuketName"] ?? "pa.blackdesert.all.web-static";
        public static readonly string _AWSBaseUrl = ConfigurationManager.AppSettings["AWSBaseUrl"] ?? "https://s1.pearlcdn.com/";
        ...
        public static readonly string _serviceProject = ConfigurationManager.AppSettings["serviceProject"] ?? "BDO";
        ...
        public static readonly bool _apiReload = ConfigurationManager.AppSettings["APIReload"].ConvertTo<bool>(false);
        public static readonly bool _isTradeWebOpen = ConfigurationManager.AppSettings["isTradeWebOpen"].ConvertTo<bool>(false);
        public static readonly string _redirectDomain = ConfigurationManager.AppSettings["redirectDomain"] ?? string.Empty;
        public static readonly string _selfServerIP = ConfigurationManager.AppSettings["selfServerIP"] ?? string.Empty;
        public static readonly int _allowIndex = ConfigurationManager.AppSettings["allowIndex"].ConvertTo<int>(-1);
        ...
        public static readonly string _allowBorwserList = ConfigurationManager.AppSettings["AllowBrowserList"] ?? string.Empty;
        ...
        public static readonly bool _isUseLocalData = ConfigurationManager.AppSettings["isUseLocalData"].ConvertTo<bool>(true);
        ...
        public static string GetLocalDataFilePath() => HttpRuntime.AppDomainAppPath + "/Contents/Common/xml";

        public static string GetS3DataFilePath() => "/" + ConstantMgr.GetDefaultLanguage.ToUpper() + "/TradeMarket/Common/xml";
